...
int main()
{
    ...
    // -------------------------
    Shader pbrShader("Shader/vertex.vs", "Shader/fragment.frag");
    Shader equirectangularToCubemapShader("Shader/light_cube.vs", "Shader/equirectangularToCubemapShader.frag");
    Shader irradianceShader("Shader/light_cube.vs", "Shader/irradiance_convolution.frag");
    Shader prefilterShader("Shader/light_cube.vs", "Shader/prefilterShader.frag");
    Shader brdfShader("Shader/brdf.vs", "Shader/brdf.frag");
    Shader backgroundShader("Shader/background.vs", "Shader/background.frag");
    ...
    Model ourModel("resources/objects/Cerberus/Cerberus_LP.FBX");
    ...
    unsigned int modelAlbedoMap = loadTexture("resources/objects/Cerberus/Textures/Cerberus_A.TGA");
    unsigned int modelNormalMap = loadTexture("resources/objects/Cerberus/Textures/Cerberus_N.TGA");
    unsigned int modelMetallicMap = loadTexture("resources/objects/Cerberus/Textures/Cerberus_M.TGA");
    unsigned int modelRoughnessMap = loadTexture("resources/objects/Cerberus/Textures/Cerberus_R.TGA");
    unsigned int modelAOMap = loadTexture("resources/objects/Cerberus/Textures/Raw/Cerberus_AO.TGA");
    ...
    // 然后重新配置捕获帧缓冲对象，并使用双向反射分布函数（BRDF）着色器渲染屏幕空间四边形。
    glBindFramebuffer(GL_FRAMEBUFFER, captureFBO);
    glBindRenderbuffer(GL_RENDERBUFFER, captureRBO);
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT24, 512, 512);
